      ...
      <div className="w-full md:w-1/2 p-6 md:p-12 lg:p-16 flex flex-col justify-between relative overflow-hidden bg-background/40 border-b md:border-b-0 md:border-r border-zinc-800">
        ...
        <div className="z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[0.95] mb-6 tracking-tight text-foreground font-display">
            DOMINATE THE <br/>
            <span className="text-brand-emerald">COURT.</span>
          </h1>
        ...
        <div className="z-10 space-y-4 mt-8 md:mt-0">
          <div className="bg-brand-amber/10 border border-brand-amber/30 p-4 rounded-xl flex gap-4 items-start max-w-md glow-amber">
            ...
            <div>
              <p className="text-brand-amber text-xs font-bold uppercase tracking-wider mb-1 font-mono">Aturan Ketat No-Show</p>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3 text-xs text-foreground focus:outline-none focus:border-brand-emerald transition-colors font-mono"
              />
            </div>
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 text-zinc-400 cursor-pointer">
                <input type="checkbox" defaultChecked className="rounded border-zinc-800 bg-zinc-900 text-brand-emerald focus:ring-brand-emerald focus:ring-offset-background" />
                <span>Ingat Saya</span>
              </label>
              <button
                type="button"
                onClick={() => alert("Gunakan password demo: 'password123' untuk akses cepat.")}
                className="text-brand-emerald hover:text-brand-neon font-bold"
              >
                Lupa Password?
              </button>
            </div>
