      ...
      <div className="w-full md:w-1/2 p-6 md:p-12 lg:p-16 flex flex-col justify-between relative overflow-hidden bg-background/40 border-b md:border-b-0 md:border-r border-zinc-800">
        ...
        <div className="z-10">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-[0.95] mb-6 tracking-tight text-foreground font-display">
            JOIN THE <br/>
            <span className="text-brand-emerald">LINEUP.</span>
          </h1>
        ...
        <div className="z-10 space-y-4 mt-8 md:mt-0">
          <div className="bg-brand-amber/10 border border-brand-amber/30 p-4 rounded-xl flex gap-4 items-start max-w-md glow-amber">
          ...
          <div className="flex items-center gap-2 text-zinc-500 text-tiny font-mono uppercase tracking-wider">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-brand-emerald">
        ...
        <div className="glass-panel w-full max-w-md p-8 md:p-10 rounded-3xl glow-emerald relative">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-micro font-bold text-zinc-500 uppercase tracking-widest font-mono">
                Pilih Peran Utama
              </label>
                ...
                {roles.map((r) => (
                  <button
                    ...
                    className={`p-2.5 rounded-xl border text-left transition-all duration-200 cursor-pointer ${
                      role === r.id
                        ? "bg-brand-emerald/10 border-brand-emerald text-brand-neon"
                        : "bg-zinc-900 border-zinc-800 text-zinc-400 hover:border-zinc-700"
                    }`}
                  >
                    <div className="text-xs font-bold">{r.label}</div>
                    <div className="text-micro text-zinc-500 leading-none mt-1 truncate">
                      {r.desc}
                    </div>
                  </button>
                ))}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900 border border-zinc-800 focus:border-brand-emerald rounded-xl py-3 pl-10 pr-4 text-xs text-foreground outline-none transition-colors"
                />
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5 pt-1">
              <input
                ...
                className="mt-1 accent-brand-emerald w-4 h-4 rounded bg-zinc-900 border-zinc-800 text-black cursor-pointer"
              />
              <label htmlFor="penalty-checkbox" className="text-micro text-zinc-400 leading-normal cursor-pointer select-none">
                Saya setuju dengan <span className="text-brand-amber font-bold">Kebijakan Hangus Mutlak 15 Menit No-Show</span> dan memahami dana disita 100% jika terlambat.
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-brand-emerald hover:bg-brand-emerald/90 text-black font-black py-4 rounded-xl transition-all glow-emerald flex items-center justify-center gap-2 uppercase tracking-tight cursor-pointer"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center border-t border-zinc-800/60 pt-4">
            <p className="text-zinc-500 text-xs">
              ...
              <button
                ...
                className="text-foreground hover:text-brand-neon font-bold underline"
              >
                Masuk Sistem
              </button>
            </p>
