...
export default function CustomerMarketplacePage() {
  ...
  const venues = [
    {
      ...
      image: "https://images.unsplash.com/photo-1508098682722-e99c43a406b2?auto=format&fit=crop&q=80&w=800", // High quality field
      rating: 4.9,
      reviews: 142,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1544698310-74ea9d1c8258?auto=format&fit=crop&q=80&w=800", // Basketball court
      rating: 4.8,
      reviews: 96,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1595435934249-5df7ed86e1c0?auto=format&fit=crop&q=80&w=800", // Tennis
      rating: 4.7,
      reviews: 58,
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1626224583764-f87db24ac4ea?auto=format&fit=crop&q=80&w=800", // Badminton
      rating: 4.6,
      reviews: 39,
  ...
  return (
    ...
    <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#4edea3]/10 border border-[#4edea3]/20 rounded-full text-xs text-[#4edea3] mb-4">
    ...
    Exploration <span className="text-emerald-500">Engine</span>
    </h1>
    ...
    <div className="bg-[#1c1b1b] border-y border-zinc-800 py-3.5 px-6">
    <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
    <div className="flex items-center gap-3">
    <div className="w-8 h-8 rounded-full bg-amber-500/10 flex items-center justify-center border border-amber-500/20 text-amber-500 glow-amber">
    <ShieldAlert className="w-4 h-4" />
    </div>
    <div>
    <p className="text-xs text-zinc-300">
    <span className="text-amber-400 font-bold uppercase font-mono tracking-wider">KEBIJAKAN NO-SHOW: </span>
    Terlambat masuk <span className="text-amber-400 font-bold">&gt;15 menit</span> menghanguskan tiket secara sepihak, dana disita 100%, dan slot sisa dirilis otomatis ke status <span className="text-emerald-400 font-bold">AVAILABLE</span>.
    </p>
    </div>
    </div>
    <div className="bg-[#09090b] px-3 py-1 rounded border border-zinc-800 text-[10px] font-mono text-zinc-500">
    ...
    className="w-full bg-[#131313] border border-zinc-800 focus:border-emerald-500 rounded-xl py-2.5 pl-10 pr-4 text-sm text-white placeholder-zinc-600 outline-none transition-all duration-200 font-sans"
    />
    </div>
    ...
    {sports.map((sport) => (
      ...
      className={`px-3.5 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 cursor-pointer ${
        ...
        : "bg-[#131313] border border-zinc-800 text-zinc-400 hover:border-zinc-700 hover:text-white"
      }`}
      >
      {sport}
      </button>
    ...
    <Zap className="w-3.5 h-3.5 text-emerald-400 animate-pulse" /> ARENA TERSEDIA ({filteredVenues.length})
    </h3>
    ...
    {filteredVenues.map((venue) => (
      ...
      className="glass-panel rounded-2xl overflow-hidden hover:border-emerald-500/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(16,185,129,0.1)] flex flex-col group cursor-pointer"
      >
      {/* Image & Badges */}
      ...
      />
      {venue.isPopular && (
        <div className="absolute top-3 left-3 bg-emerald-500 text-black text-[9px] font-mono font-black px-2 py-0.5 rounded tracking-wider uppercase glow-emerald">
        POPULAR
        </div>
      )}
      <div className="absolute top-3 right-3 bg-black/70 backdrop-blur-md text-[#e5e2e1] text-[10px] font-mono px-2 py-0.5 rounded flex items-center gap-1 border border-zinc-800">
      ...
      <h4 className="text-base font-bold text-[#e5e2e1] mb-1.5 line-clamp-1 group-hover:text-emerald-400 transition-colors">
      {venue.name}
      </h4>
      ...
      {venue.tags.map((tag, i) => (
        <span
        key={i}
        className="bg-[#1c1b1b] text-zinc-400 text-[9px] px-2 py-0.5 rounded font-mono border border-zinc-800/60"
        >
        {tag}
        </span>
      ))}
      ...
      <span className="text-xs font-mono font-bold text-emerald-400 mt-1 block">{venue.price}</span>
      </div>
      <div className="w-8 h-8 rounded-lg bg-zinc-800 group-hover:bg-emerald-500 group-hover:text-black transition-all flex items-center justify-center text-zinc-400 group-hover:glow-emerald">
