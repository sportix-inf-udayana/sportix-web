        ...
        <div className="flex border-b border-zinc-800/80 gap-6 mb-8">
          <button
            ...
            className={`pb-4 text-sm font-semibold relative transition-all duration-200 cursor-pointer ${
              activeTab === "tickets" ? "text-brand-neon font-bold" : "text-zinc-500 hover:text-zinc-300"
            }`}
          >
            My Tickets
            ...
            <div className="bg-surface-hover border-l-2 border-brand-amber p-4 rounded-r-lg flex gap-3.5 items-start">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400 leading-normal mt-0.5 font-sans">
                  Terlambat masuk <span className="text-brand-amber font-bold">&gt;15 menit</span> menghanguskan tiket secara sepihak, dana disita 100%, dan slot sisa dirilis otomatis kembali ke status <span className="text-brand-neon font-bold">AVAILABLE</span>. Tunjukkan barcode tiket Anda pada pintu masuk scanning di lapangan.
                </p>
              </div>
            </div>
            ...
            {tickets.length === 0 ? (
              <div className="text-center py-12 glass-panel rounded-2xl border-zinc-850">
                ...
                <button
                  ...
                  className="bg-brand-emerald hover:bg-brand-emerald/90 text-black font-black text-xs py-2.5 px-5 rounded-lg transition-all duration-200 glow-emerald cursor-pointer uppercase tracking-wider"
                >
                  ...
                  return (
                    <div
                      ...
                      className={`glass-panel rounded-2xl overflow-hidden shadow-xl transition-all duration-300 flex flex-col justify-between ${
                        isActive ? "border-brand-emerald/40 hover:border-brand-emerald/80" : "border-zinc-800 opacity-60"
                      }`}
                    >
                      {/* Top color strap */}
                      <div className={`h-1.5 ${isActive ? "bg-brand-emerald glow-emerald" : "bg-zinc-600"}`} />
                      ...
                      <div className="p-5 flex-1">
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <span className={`text-micro font-mono font-bold px-2 py-1 rounded uppercase tracking-wider ${
                            isActive ? "bg-brand-emerald/15 text-brand-neon border border-brand-emerald/20" : "bg-zinc-800 text-zinc-500"
                          }`}>
                            {t.status}
                          </span>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-y-3 gap-x-4 border-y border-zinc-800/80 py-4 mb-4 text-xs font-mono">
                          ...
                          <div>
                            ...
                            <span className="text-brand-neon font-bold">{t.time}</span>
                          </div>
                          <div>
                            <span className="text-micro text-zinc-500 uppercase block">GATE / SEAT ASSIGN</span>
                          ...
                          <div>
                            ...
                            <span className="text-brand-amber font-bold">{t.price}</span>
                          </div>
                        </div>
                        ...
                        {isActive ? (
                          ...
                          <div className="bg-surface-elevated rounded p-4 text-center border border-zinc-800/60 flex items-center justify-center gap-2 text-zinc-500 font-mono text-xs">
