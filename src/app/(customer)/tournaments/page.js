    ...
    <div className="bg-background text-foreground min-h-screen pb-16 font-sans select-none">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* Tournament card and registration form */}
          <div className="lg:col-span-7 glass-panel rounded-2xl overflow-hidden shadow-2xl relative flex flex-col justify-between">
            <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-brand-neon to-brand-emerald glow-emerald" />
            ...
            <div className="relative h-56 bg-zinc-900">
              ...
              <div className="absolute bottom-6 left-6">
                <span className="bg-brand-emerald/10 border border-brand-emerald/30 text-brand-neon text-micro font-mono font-bold px-2.5 py-1 rounded-full uppercase tracking-wider glow-emerald">
                  Bali League Series
                </span>
            ...
            <div className="p-6 space-y-6">
              <div>
                <h4 className="text-micro font-mono text-zinc-500 uppercase tracking-widest mb-3.5 flex items-center gap-1">
                  <CheckCircle className="w-3.5 h-3.5 text-brand-neon" /> Registration Requirements
                </h4>
              ...
              {success && (
                <div className="p-4 bg-brand-emerald/10 border border-brand-emerald/20 rounded-lg text-xs text-brand-neon space-y-1 font-sans">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <h4 className="text-micro font-mono text-zinc-500 uppercase tracking-widest">
                  Roster Submission
                </h4>

                <div>
                  <label className="text-micro font-mono text-zinc-400 block mb-1.5 uppercase">
                    Team Name
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-surface-elevated border border-zinc-800 focus:border-brand-emerald rounded-xl py-2.5 px-3 text-sm text-foreground placeholder-zinc-700 outline-none transition-all duration-200 font-sans"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-surface-elevated border border-zinc-800 focus:border-brand-emerald rounded-xl py-2.5 px-3 text-sm text-foreground placeholder-zinc-700 outline-none transition-all duration-200 font-mono resize-none leading-relaxed"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-brand-emerald hover:bg-brand-emerald/90 text-black font-black text-xs py-4 rounded-xl flex items-center justify-center gap-2 transition-all duration-300 tracking-wider uppercase glow-emerald cursor-pointer"
                >
                  {submitting ? (
