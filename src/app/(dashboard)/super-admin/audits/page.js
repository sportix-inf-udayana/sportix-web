...
export default async function SuperAdminAuditsPage() {
  ...
  const metrics = await getGlobalFinancialMetrics(supabase) || { integrityMismatch: 0, forfeitedCount: 0, unprocessedRefundsCount: 0, totalVolume: 0, ledgerStream: [] };

  // PERBAIKAN: Menghapus <SuperAdminHeader /> karena sudah di-handle oleh layout.js. 
  // Struktur div disamakan dengan halaman verifications agar konsisten.
  return (
