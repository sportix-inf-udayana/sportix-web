// src/components/admin-venue/SecurityLogsClient.js
"use client";
  ...
  return (
    <div className="space-y-6 w-full text-white font-sans">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-zinc-800 pb-4">
        <div>
          <h1 className="text-2xl font-black text-white font-display uppercase tracking-tight">Access & Security Logs</h1>
              ...
              <tbody className="divide-y divide-zinc-800/60">
                {logs.map((log) => (
                  <tr key={log.id} className="hover:bg-zinc-800/40 transition-colors">
                    ...
                    <td className="px-6 py-4 font-bold text-zinc-300">{log.event}</td>
